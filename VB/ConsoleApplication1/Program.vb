...
Namespace ConsoleApplication1
	Friend Class Program
		Shared Sub Main(ByVal args() As String)
			...
			Dim items As XPCollection(Of QuoteItem) = New XPCollection(Of QuoteItem)(New OperandProperty("Quote.Oid") = q.Oid, New SortProperty("Sequence", SortingDirection.Descending))
